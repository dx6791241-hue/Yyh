...
def show_update_log():
    ...
    print("\033[1;97mDELAY TOOL ZEFOY DO CÓ MỘT SỐ LỖI CÀN PHẢI GIẢI QUYẾT\033[0m\n")
    print("\033[1;97mCÓ THỂ UPDATE TOOL AUTO UP LOCKET GOLD CHO BỌN KID THÍCH FLEX\033[0m\n")
    print("\033[1;97mCÓ THỂ TUI SẼ NGHỈ MỘT THỜI GIAN DÀI ĐỂ ÔN THI THPT QUỐC GIA,MONG MN THÔNG CẢM ,BAO GIỜ THI XONG TUI SẼ UPD CHO ANH EM\033[0m\n")
    print("\033[1;97mNẾU AE DÙNG TOOL GẶP LỖI GÌ THÌ HÃY REPORT BẰNG CÁCH VÀO ZÉP LÀO CỦA CỦA TÔI,TÔI CHỈ CÓ THỂ XỬ LÝ TRONG THẢNG 8 THÔI NGHEN\033[0m\n")
