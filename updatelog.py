...
def show_update_log():
    ...
    updates = [
        "• UPDATE TOOL REG PRO5 FACEBOOK",
        "• TOOL AUTO COMMENT ,TT BÀI VIẾT FB",
    ...
    print("\033[1;97m(UPDATE TOOL GOLIKE (CÓ LẼ SẼ LÂU VÌ ADMIN BẬN THI))\033[0m\n")
